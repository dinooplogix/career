...
<div class="register-form form">
    ...
    <form action="" method="POST" name="password_reset">
        ...
        <p><input type="password" name="user_pass"  placeholder="Password" class="form-control" /></p>
        <p><input type="password" name="confirm_password"  placeholder="Confirm Password" class="form-control" /></p>
